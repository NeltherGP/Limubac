...
*/
    ...
    public function finanzasAction(){
        ...
        return $this->render('limubacadministratorBundle:administracion:finanzas.html.twig', array('fondo' => $fon, 'ingresos' => $ing, 'egresos' => $egr, 'pendientes' => $pen, 'query' => $resul, 'torneos' => $resultor));
    }
