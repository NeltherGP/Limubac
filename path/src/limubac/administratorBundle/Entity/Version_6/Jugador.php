 ...
 * Jugador
 *
 * @ORM\Table(name="jugador", indexes={@ORM\Index(name="IDX_527D6F184BE15F3A", columns={"id_tiposanguineo"}), @ORM\Index(name="IDX_527D6F1886373DD7", columns={"id_genero"}), @ORM\Index(name="IDX_527D6F185D37D0F1", columns={"id_status"}), @ORM\Index(name="id_status", columns={"id_status", "id_genero", "id_tiposanguineo"})})
 * @ORM\Entity
 */
class Jugador
{
