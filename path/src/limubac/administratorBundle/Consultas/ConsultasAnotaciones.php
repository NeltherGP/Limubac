...
class ConsultasAnotaciones{
	...
	function getEquipoByPartido($idPartido,$manager){
		$consulta = $manager ->createQuery('SELECT e.nombre, j.side, r.nombre as rama, c.nombre as categoria, s.nombre as lugar, t.nombre as torneo from limubacadministratorBundle:Equipo e 
